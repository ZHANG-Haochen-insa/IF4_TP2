...
![P控制器响应](BF/p_controller_response.png)
...
![PI控制器响应](BF/pi_controller_response.png)
...
本实验成功实现了基于FreeRTOS的移动机器人开环控制、速度测量和闭环速度控制程序。主要收获包括：
...
- **2.3 速度控制**：`BF/BF.ino`
- **数据可视化**：`BF/plot_p_controller.py`, `BF/plot_pi_controller.py`
